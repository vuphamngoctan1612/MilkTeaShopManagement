...
ALTER TABLE Drinks ALTER COLUMN Price Int;
ALTER TABLE Staff ALTER COLUMN BasicSalary INT;
ALTER TABLE Staff ALTER COLUMN Salary INT;
INSERT INTO Staff VALUES ('NHANVIEN001',N'Nguy?n V?n Minh','2001-10-20',N'Pha Ch?','NV001',20000,96,1920000);
INSERT INTO Staff VALUES ('NHANVIEN002',N'Nguy?n Th? Di?m Qu?nh','2001-01-8',N'Thu Ngân','NV002',25000,96,2400000);
INSERT INTO Staff VALUES ('NHANVIEN003',N'Ph?m Th?ch Th?o','2001-10-20',N'Ph?c V?','NV003',20000,96,1920000);
DROP TABLE BillStructure;
CREATE TABLE BillStructure 
(
	BillID CHAR(50),
	DrinksID CHAR(50),
	Amount INT,
	CONSTRAINT PK_BillStructure PRIMARY KEY (BillID, DrinksID)
)