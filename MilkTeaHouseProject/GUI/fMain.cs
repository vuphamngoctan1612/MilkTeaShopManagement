...
namespace MilkTeaHouseProject
{
    public partial class fMain : Form
    {
        ...
        {
            int dd = (int)DateTime.Now.Day;
            int mm = (int)DateTime.Now.Month;
            int yy = (int)DateTime.Now.Year;
            this.lbCountbill.Text = ReportDAL.Instance.GetNumberOfBillsPaid(dd, mm, yy).ToString();
        }     
        #endregion
    }
}
